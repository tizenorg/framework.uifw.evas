...
/**
 * Evas will orphan existing font data until it is unreferenced and
 * start with a fresh font configuration read from any appropriate
 * system resources for all newly loaded/created fonts.
 *
 * @ingroup Evas_Font_Group
 */
...
typedef enum _Evas_Text_Style_Type
{
   ...
   EVAS_TEXT_STYLE_TIZEN_GLOW_SHADOW,
 ...
 * Return the text and markup tags in the range between cur1 and cur2.
 * If there is some markup tags that affect to text.
 *
 * @param cur1 one side of the range.
 * @param cur2 the other side of the range
 * @return the text in the range and some markup tags that affect to text.
