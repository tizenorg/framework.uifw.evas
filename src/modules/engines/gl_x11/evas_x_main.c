...
# endif
    ...
    * Enable both DEPTH and STENCIL buffers ALWAYS.
    * This should not go upstream, as the surface should instead
    * be reconfigured on-the-fly when these buffers are needed.
    * See comment in _internal_config_set() as well.
    */
